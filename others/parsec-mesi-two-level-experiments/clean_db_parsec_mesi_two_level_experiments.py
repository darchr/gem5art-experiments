	...
	for num_cpu in num_cpus:
		for size in sizes:
			for bm in benchmarks:      
				db.artifacts.remove({'outdir':'/home/mahyar/Workplace/DArchR/gem5art-experiments/launch-scripts/results/run_parsec_mesi_two_level/{}/{}/{}/{}'.format(bm, size, cpu, num_cpu)})
